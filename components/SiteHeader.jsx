...
export default function SiteHeader({ locale = "en" }) {
  ...
  // ✅ English = no prefix, French = /fr prefix
  const prefix = loc === "fr" ? "/fr" : "";

  // Helper to build internal links
  const l = (path) => `${prefix}${path === "/" ? "" : path}`;

  // Labels
  const t = {
    tagline:
      loc === "fr"
        ? "sélection pensée pour les grandes tailles"
    ...
    workwear:
      loc === "fr"
        ? "Tenues de travail pour grandes femmes"
        : "Tall women workwear",
    ...
    workout:
      loc === "fr"
        ? "Vêtements de sport pour grandes femmes"
    ...
    <header className="sticky top-0 z-50 border-b border-neutral-200 bg-white/80 backdrop-blur">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* ✅ Language toggle: English is "/", French is "/fr" */}
          <Link
            href={loc === "fr" ? "/" : "/fr"}
