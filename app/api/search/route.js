...
export async function GET(request) {
  ...
  const gender = norm(searchParams.get("gender") || "all") // ✅ NEW
  ...
  const products = [
...

    {
      ...
      store: "Amazon.ca",
      categories: ["tops"],
      genders: ["women"], // adjust if needed
      tall: true,
    ...
    },
    {
      id: "amz-B0DQ1N8RXL",
      asin: "B0DQ1N8RXL",
      title: "Lightweight Workout Pants",
      brand: "Amazon",
      store: "Amazon.ca",
      categories: ["bottoms"],
      genders: ["women"],
    ...
    },
    {
      id: "amz-B0DB8JQHB3",
      asin: "B0DB8JQHB3",
      title: "Mid Waisted Stretchy Loose Jeans",
      brand: "Amazon",
      store: "Amazon.ca",
      categories: ["bottoms"],
      genders: ["women"],
    ...
    },
    {
      id: "amz-B0F2XZJBP4",
      asin: "B0F2XZJBP4",
      title: "High Waisted Belted Pants",
      brand: "Amazon",
      store: "Amazon.ca",
      categories: ["bottoms"],
      genders: ["women"],
      tall: true,
      image: "https://m.media-amazon.com/images/I/61HLJjWCHLL._AC_SY741_.jpg",
      url: amazonLink("B0F2XZJBP4"),
      source: "amazon",
    },
    {
      id: "amz-B0BTBZ5GDK",
      asin: "B0BTBZ5GDK",
      title: "High Waisted Casual Straight Leg Pants",
      brand: "Amazon",
      store: "Amazon.ca",
      categories: ["bottoms"],
      genders: ["women"],
      tall: true,
      image: "https://m.media-amazon.com/images/I/617WzEouKsL._AC_SY500_.jpg",
      url: amazonLink("B0BTBZ5GDK"),
      source: "amazon",
    },
    {
      id: "amz-B08K2SFHLW",
      ...
      genders: ["women"],
      tall: true,
      image: "https://m.media-amazon.com/images/I/51pskCoZTYL._AC_SY500_.jpg",
      url: amazonLink("B08K2SFHLW"),
      source: "amazon",
    },
    {
      id: "amz-B07CSNKYMC",
      asin: "B07CSNKYMC",
      title: "Lee Womens Secretly Shapes Regular Fit Straight Leg Pant",
      brand: "Amazon",
      store: "Amazon.ca",
      categories: ["bottoms"],
      genders: ["women"],
      tall: true,
      image: "https://m.media-amazon.com/images/I/61D95sPem-L._AC_SX569_.jpg",
      url: amazonLink("B07CSNKYMC"),
      source: "amazon",
    },
    {
      id: "amz-B083LNXVM8",
      asin: "B083LNXVM8",
      title: "Briggs New York Womens Pull on Dress Pant",
      brand: "Amazon",
      store: "Amazon.ca",
      categories: ["bottoms"],
      genders: ["women"],
      tall: true,
      image: "https://m.media-amazon.com/images/I/61uSQdeKUDL._AC_SX569_.jpg",
      url: amazonLink("B083LNXVM8"),
      source: "amazon",
    },
    {
      id: "amz-B0D8WFSC7J",
      asin: "B0D8WFSC7J",
      title: "Lee Womens Plus Size Relaxed Fit Plain Front Straight-Leg Pant",
      brand: "Amazon",
      store: "Amazon.ca",
      categories: ["bottoms"],
      genders: ["women"],
      tall: true,
      image: "https://m.media-amazon.com/images/I/61bU97MGoaL._AC_SY741_.jpg",
      url: amazonLink("B0D8WFSC7J"),
      source: "amazon",
    },
  ]
  ...
  // ✅ NEW: Gender filter (women/men). If genders missing, treat as "everyone".
